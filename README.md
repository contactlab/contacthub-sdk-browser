...
```html
<script async src="https://unpkg.com/@contactlab/sdk-browser@2/sdk.legacy.min.js"></script>
```

#### ES5 version uncompressed

```html
<script async src="https://unpkg.com/@contactlab/sdk-browser@2/sdk.legacy.js"></script>
```
